...
<!-- nav-->
        <nav class="navbar navbar-expand-lg navbar-dark sticky-top" id="navibar">
            <a class="navbar-brand" href="http://localhost:8888"><img src="<?php echo get_bloginfo('template_directory'); ?>/assets/img/logo-min.webp" height="35" width="35" class="d-inline-block"></a>
