...
<section id="sec2_bhp">
	<div class="container">
        ...
        <div class="row">
			<div class="col-md-10 col-12">
                <h2><?php echo $oferta_zdanie ?></h2>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h2 class="text-center"><?php echo $tyt_oferta1 ?></h2>
                <p class="text-center"><?php echo $oferta1 ?></p>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h2 class="text-center"><?php echo $tyt_oferta2 ?></h2>
                <p class="text-center"><?php echo $oferta2 ?></p>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h2 class="text-center"><?php echo $tyt_oferta3 ?></h2>
                <p class="text-center"><?php echo $oferta3 ?></p>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h2 class="text-center"><?php echo $tyt_oferta4 ?></h2>
                <p class="text-center"><?php echo $oferta4 ?></p>
                <ul>
        ...
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h2 class="text-center"><?php echo $tyt_oferta5 ?></h2>
                <p class="text-center"><?php echo $oferta5 ?></p>
                <ul>
        ...
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h2 class="text-center"><?php echo $tyt_oferta6 ?></h2>
                <p class="text-center"><?php echo $oferta6 ?></p>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h2 class="text-center"><?php echo $tyt_oferta7 ?></h2>
                <p class="text-center"><?php echo $oferta7 ?></p>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h2 class="text-center"><?php echo $tyt_oferta8 ?></h2>
                <p class="text-center"><?php echo $oferta8 ?></p>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h2 class="text-center"><?php echo $tyt_oferta9 ?></h2>
                <p class="text-center"><?php echo $oferta9 ?></p>
			</div>
        </div>
        <div class="row">
			<div class="col-md-10 col-12">
				<h2><?php echo $nie_wyczer ?></h2>
                <h2><?php echo $info_cen ?></h2>
			</div>
        </div>
	</div>
</section>
