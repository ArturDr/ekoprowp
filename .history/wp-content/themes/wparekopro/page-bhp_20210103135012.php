...
<section id="sec2_bhp">
	<div class="container">
        ...
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h3 class="text-center"><?php echo $tyt_oferta1 ?></h3>
                <p class="text-center"><?php echo $oferta1 ?></p>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h3 class="text-center"><?php echo $tyt_oferta2 ?></h3>
                <p class="text-center"><?php echo $oferta2 ?></p>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h3 class="text-center"><?php echo $tyt_oferta3 ?></h3>
                <p class="text-center"><?php echo $oferta3 ?></p>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h3 class="text-center"><?php echo $tyt_oferta4 ?></h3>
        ...
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h3 class="text-center"><?php echo $tyt_oferta5 ?></h3>
        ...
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h3 class="text-center"><?php echo $tyt_oferta6 ?></h3>
                <p class="text-center"><?php echo $oferta6 ?></p>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h3 class="text-center"><?php echo $tyt_oferta7 ?></h3>
                <p class="text-center"><?php echo $oferta7 ?></p>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h3 class="text-center"><?php echo $tyt_oferta8 ?></h3>
                <p class="text-center"><?php echo $oferta8 ?></p>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				<h3 class="text-center"><?php echo $tyt_oferta9 ?></h3>
