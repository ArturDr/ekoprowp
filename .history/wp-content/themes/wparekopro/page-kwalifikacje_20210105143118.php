	...
	<div class="container">
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				...
				<p class="specjal">bezpieczeństwo i higiena pracy</p>   w lipcu 2011 roku spełniając tym samym wymagania kwalifikacyjne określone w
				<stong>Rozporządzeniu Rady Ministrów w sprawie służby bezpieczeństwa i higieny pracy z dnia 2 listopada 2004 r.</stong>
        ...
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
				...
				<p class="specjal">zarządzanie środowiskiem i gospodarka odpadami.</p> Studia magisterskie ukończył w marcu 2014 roku.</p>
			</div>
        </div>
        <div class="row justify-content-center">
			<div class="col-md-10 col-12">
